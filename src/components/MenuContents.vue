<template>
      <div class="catalogs" v-bind:class="{visible:showCatalog}" v-on:touchstart="handleStart" v-on:touchend="handleEnd">
            <div class="menu-contents">
                  ...
                  <ul class="catalog">
                        <li v-for="(catalog, index) in dishsData" v-bind:class="{active:index==activeCatalog}" v-on:click="updateCatalog(index)">
...
export default {
      props: ['activeCatalog', 'toggleMenu', 'dishsData', 'showCatalog'],
      data: function() {
            return {
                  touchStartPos: 0
            };
